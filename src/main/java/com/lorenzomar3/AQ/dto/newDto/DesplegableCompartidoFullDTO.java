...
public record DesplegableCompartidoFullDTO(Long id, String titulo, String descripcion, Long idDuenio,
                                            ...
                                            String imagenTitulo, List<OpcionDeDesplegableCompartidoFullDTO> listaDeOpciones,
